...
public class Overworld {
  ...
  private static Location loadStarterCave() {
    ...
    caveRoom_1.addCharacter(new Skeleton(1));
    Room caveRoom_2 = new Room(1);
    caveRoom_2.addCharacter(new Skeleton(1));
    Room caveRoom_3 = new Room(1);
    caveRoom_3.addCharacter(new Skeleton(2));
  ...
  private static Location loadForest() {
    ...
    forestRoom_1.addCharacter(new Slime(1));
    Room forestRoom_2 = new Room(1);
    forestRoom_2.addCharacter(new Skeleton(2));
    Room forestRoom_3 = new Room(1);
    forestRoom_3.addCharacter(new Slime(2));
    Room forestRoom_4 = new Room(1);
    forestRoom_4.addCharacter(new SkeletonMage(3));
